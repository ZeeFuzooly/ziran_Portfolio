...
export const experiencesData = [
  {
    ...
    description: [
      "Lead frontend architecture (React, TypeScript, Design System, State Management) focusing on performance, scalability, and accessibility.",
      "Translate product feedback from Head of Medical and Head of Education into actionable technical requirements and roadmap priorities.",
      "Define and maintain the design system, ensuring visual consistency and adherence to accessibility standards.",
      "Champion learner and educator experience across engineering, ensuring all sprints deliver measurable UX improvements.",
      "Collaborate with Data/AI teams to integrate analytics dashboards and experience insights into the platform.",
      "Manage and mentor a cross-functional engineering team, setting coding standards, conducting reviews, and fostering a culture of excellence.",
      "Recruit and onboard new engineering talent, scaling the product and design teams to meet growing organizational needs.",
      "Act as an Engineering Manager, overseeing sprint planning, agile ceremonies, and inter-team coordination to ensure on-time delivery.",
    ],
...
export const projectsData = [
  {
    ...
    fullDescription:
      "I lead the frontend and product experience engineering for SimHealth AI, an innovative platform redefining healthcare education through AI-driven dietetic simulations aligned with HCPC and BDA standards. The platform enables universities and healthcare institutions to train and assess learners using immersive, data-driven clinical scenarios.",
    contributions: [
      "Frontend Architecture & Design System – Spearheaded the development of a modular, component-driven frontend architecture using React.js, TypeScript, and Tailwind CSS, improving scalability, performance, and maintainability.",
      "User Experience & Accessibility – Defined and maintained a WCAG-compliant design system, ensuring accessibility, visual consistency, and usability across simulation interfaces.",
      "Simulation & AI Integration – Built interactive simulation modules integrated with FastAPI microservices for real-time feedback, analytics, and adaptive learning experiences.",
      "Performance Optimization – Enhanced responsiveness and load times through code-splitting, lazy loading, and advanced state management strategies.",
      "Cross-Functional Collaboration – Partnered with the Head of Medical and Head of Education to translate clinical and pedagogical feedback into actionable product features.",
      "Team Leadership & Mentorship – Managed a cross-functional engineering team, established coding standards, and led Agile sprint planning and code reviews to ensure delivery excellence.",
      "Recruitment & Onboarding – Contributed to scaling the engineering and design teams by hiring, mentoring, and onboarding new developers.",
    ],
